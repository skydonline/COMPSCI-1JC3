...
-----------------------------------------------------------------------------------------------------------
lessThan :: Ord a => a -> Tree a -> Bool
lessThan c (Leaf a) = c < a
lessThan c (Node v t1 t0) = c < v && (lessThan c t0)

greaterThan :: Ord a => a -> Tree a -> Bool
greaterThan c (Leaf a) = c >= a
greaterThan c (Node v t1 t0) = c >= v && (greaterThan c t1)

isSearchTree :: Ord a => Tree a -> Bool
isSearchTree (Leaf n) = True
isSearchTree (Node v t0 t1) = (greaterThan v t0) && (lessThan v t1) && (isSearchTree t0) && (isSearchTree t1)
...
-----------------------------------------------------------------------------------------------------------
pivot :: Ord a => a -> [a] -> ([a],[a])
pivot v xs = ([x | x <- xs, x <= v], [y | y <- xs, y > v])